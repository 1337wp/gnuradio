   ...
   0000                     471 	.ds 8
                    ...
                    FC00    676 _EP8FIFOBUF	=	0xfc00
                            ...
                            709 	.area CSEG    (CODE)
                            710 ;------------------------------------------------------------
                            711 ;Allocation info for local variables in function 'init_usrp'
                            712 ;------------------------------------------------------------
                            713 ;------------------------------------------------------------
                            714 ;	../common/usrp_common.c:30: init_usrp (void)
                            715 ;	-----------------------------------------
                            716 ;	 function init_usrp
                            717 ;	-----------------------------------------
   051A                     718 _init_usrp:
                    0002    719 	ar2 = 0x02
                    0003    720 	ar3 = 0x03
                    ...
                    0000    725 	ar0 = 0x00
                    0001    726 	ar1 = 0x01
                            727 ;	../common/usrp_common.c:32: CPUCS = bmCLKSPD1;	// CPU runs @ 48 MHz
   051A 90 E6 00            728 	mov	dptr,#_CPUCS
   051D 74 10               729 	mov	a,#0x10
   051F F0                  730 	movx	@dptr,a
                            731 ;	../common/usrp_common.c:33: CKCON = 0;		// MOVX takes 2 cycles
   0520 75 8E 00            732 	mov	_CKCON,#0x00
                            733 ;	../common/usrp_common.c:37: IFCONFIG = bmIFCLKSRC | bm3048MHZ | bmIFCLKOE | bmIFCLKPOL | bmIFGPIF;
   0523 90 E6 01            734 	mov	dptr,#_IFCONFIG
   0526 74 F2               735 	mov	a,#0xF2
   0528 F0                  736 	movx	@dptr,a
                            737 ;	../common/usrp_common.c:38: SYNCDELAY;
   0529 00                  738 	 nop; nop; nop; 
                            739 ;	../common/usrp_common.c:42: IOA = bmPORT_A_INITIAL;	// Port A initial state
   052A 75 80 38            740 	mov	_IOA,#0x38
                            741 ;	../common/usrp_common.c:43: OEA = bmPORT_A_OUTPUTS;	// Port A direction register
   052D 75 B2 3B            742 	mov	_OEA,#0x3B
                            743 ;	../common/usrp_common.c:45: IOC = bmPORT_C_INITIAL;	// Port C initial state
   0530 75 A0 C0            744 	mov	_IOC,#0xC0
                            745 ;	../common/usrp_common.c:46: OEC = bmPORT_C_OUTPUTS;	// Port C direction register
   0533 75 B4 CF            746 	mov	_OEC,#0xCF
                            747 ;	../common/usrp_common.c:48: IOE = bmPORT_E_INITIAL;	// Port E initial state
   0536 75 B1 F0            748 	mov	_IOE,#0xF0
                            749 ;	../common/usrp_common.c:49: OEE = bmPORT_E_OUTPUTS;	// Port E direction register
   0539 75 B6 F8            750 	mov	_OEE,#0xF8
                            751 ;	../common/usrp_common.c:57: EP1OUTCFG = bmVALID | bmBULK;				SYNCDELAY;
   053C 90 E6 10            752 	mov	dptr,#_EP1OUTCFG
   053F 74 A0               753 	mov	a,#0xA0
   0541 F0                  754 	movx	@dptr,a
   0542 00                  755 	 nop; nop; nop; 
                            756 ;	../common/usrp_common.c:58: EP1INCFG  = bmVALID | bmBULK | bmIN;			SYNCDELAY;
   0543 90 E6 11            757 	mov	dptr,#_EP1INCFG
   0546 74 E0               758 	mov	a,#0xE0
   0548 F0                  759 	movx	@dptr,a
   0549 00                  760 	 nop; nop; nop; 
                            761 ;	../common/usrp_common.c:60: EP2CFG    = bmVALID | bmBULK | bmQUADBUF;		SYNCDELAY;	// 512 quad bulk OUT
   054A 90 E6 12            762 	mov	dptr,#_EP2CFG
   054D 74 A0               763 	mov	a,#0xA0
   054F F0                  764 	movx	@dptr,a
   0550 00                  765 	 nop; nop; nop; 
                            766 ;	../common/usrp_common.c:61: EP4CFG    = 0;					SYNCDELAY;	// disabled
   0551 90 E6 13            767 	mov	dptr,#_EP4CFG
   0554 E4                  768 	clr	a
   0555 F0                  769 	movx	@dptr,a
   0556 00                  770 	 nop; nop; nop; 
                            771 ;	../common/usrp_common.c:62: EP6CFG    = bmVALID | bmBULK | bmQUADBUF | bmIN;	SYNCDELAY;	// 512 quad bulk IN
   0557 90 E6 14            772 	mov	dptr,#_EP6CFG
   055A 74 E0               773 	mov	a,#0xE0
   055C F0                  774 	movx	@dptr,a
   055D 00                  775 	 nop; nop; nop; 
                            776 ;	../common/usrp_common.c:63: EP8CFG    = 0;					SYNCDELAY;	// disabled
   055E 90 E6 15            777 	mov	dptr,#_EP8CFG
   0561 E4                  778 	clr	a
   0562 F0                  779 	movx	@dptr,a
   0563 00                  780 	 nop; nop; nop; 
                            781 ;	../common/usrp_common.c:67: FIFORESET = bmNAKALL;					SYNCDELAY;
   0564 90 E6 04            782 	mov	dptr,#_FIFORESET
   0567 74 80               783 	mov	a,#0x80
   0569 F0                  784 	movx	@dptr,a
   056A 00                  785 	 nop; nop; nop; 
                            786 ;	../common/usrp_common.c:68: FIFORESET = 2;					SYNCDELAY;
   056B 90 E6 04            787 	mov	dptr,#_FIFORESET
   056E 74 02               788 	mov	a,#0x02
   0570 F0                  789 	movx	@dptr,a
   0571 00                  790 	 nop; nop; nop; 
                            791 ;	../common/usrp_common.c:70: FIFORESET = 6;					SYNCDELAY;
   0572 90 E6 04            792 	mov	dptr,#_FIFORESET
   0575 74 06               793 	mov	a,#0x06
   0577 F0                  794 	movx	@dptr,a
   0578 00                  795 	 nop; nop; nop; 
                            796 ;	../common/usrp_common.c:72: FIFORESET = 0;					SYNCDELAY;
   0579 90 E6 04            797 	mov	dptr,#_FIFORESET
   057C E4                  798 	clr	a
   057D F0                  799 	movx	@dptr,a
   057E 00                  800 	 nop; nop; nop; 
                            801 ;	../common/usrp_common.c:78: EP2FIFOCFG =             bmWORDWIDE;			SYNCDELAY;
   057F 90 E6 18            802 	mov	dptr,#_EP2FIFOCFG
   0582 74 01               803 	mov	a,#0x01
   0584 F0                  804 	movx	@dptr,a
   0585 00                  805 	 nop; nop; nop; 
                            806 ;	../common/usrp_common.c:79: EP2FIFOCFG = bmAUTOOUT | bmWORDWIDE;			SYNCDELAY;
   0586 90 E6 18            807 	mov	dptr,#_EP2FIFOCFG
   0589 74 11               808 	mov	a,#0x11
   058B F0                  809 	movx	@dptr,a
   058C 00                  810 	 nop; nop; nop; 
                            811 ;	../common/usrp_common.c:80: EP6FIFOCFG = bmAUTOIN  | bmWORDWIDE;			SYNCDELAY;
   058D 90 E6 1A            812 	mov	dptr,#_EP6FIFOCFG
   0590 74 09               813 	mov	a,#0x09
   0592 F0                  814 	movx	@dptr,a
   0593 00                  815 	 nop; nop; nop; 
                            816 ;	../common/usrp_common.c:92: EP0BCH = 0;			SYNCDELAY;
   0594 90 E6 8A            817 	mov	dptr,#_EP0BCH
   0597 E4                  818 	clr	a
   0598 F0                  819 	movx	@dptr,a
   0599 00                  820 	 nop; nop; nop; 
                            821 ;	../common/usrp_common.c:96: EP1OUTBC = 0;			SYNCDELAY;
   059A 90 E6 8D            822 	mov	dptr,#_EP1OUTBC
   059D E4                  823 	clr	a
   059E F0                  824 	movx	@dptr,a
   059F 00                  825 	 nop; nop; nop; 
                            826 ;	../common/usrp_common.c:98: EP2GPIFFLGSEL = 0x01;		SYNCDELAY; // For EP2OUT, GPIF uses EF flag
   05A0 90 E6 D2            827 	mov	dptr,#_EP2GPIFFLGSEL
   05A3 74 01               828 	mov	a,#0x01
   05A5 F0                  829 	movx	@dptr,a
   05A6 00                  830 	 nop; nop; nop; 
                            831 ;	../common/usrp_common.c:99: EP6GPIFFLGSEL = 0x02;		SYNCDELAY; // For EP6IN,  GPIF uses FF flag
   05A7 90 E6 E2            832 	mov	dptr,#_EP6GPIFFLGSEL
   05AA 74 02               833 	mov	a,#0x02
   05AC F0                  834 	movx	@dptr,a
   05AD 00                  835 	 nop; nop; nop; 
                            836 ;	../common/usrp_common.c:104: EP6AUTOINLENH = (512) >> 8;	SYNCDELAY;  // this is the length for high speed
   05AE 90 E6 24            837 	mov	dptr,#_EP6AUTOINLENH
   05B1 74 02               838 	mov	a,#0x02
   05B3 F0                  839 	movx	@dptr,a
   05B4 00                  840 	 nop; nop; nop; 
                            841 ;	../common/usrp_common.c:105: EP6AUTOINLENL = (512) & 0xff; SYNCDELAY;
   05B5 90 E6 25            842 	mov	dptr,#_EP6AUTOINLENL
   05B8 E4                  843 	clr	a
   05B9 F0                  844 	movx	@dptr,a
   05BA 00                  845 	 nop; nop; nop; 
                            846 ;	../common/usrp_common.c:107: init_board ();
   05BB 02 06 51            847 	ljmp	_init_board
                            848 	.area CSEG    (CODE)
                            849 	.area CONST   (CODE)
