...
;------------------------------------------------------------
;	eeprom_io.c:29: eeprom_read (unsigned char i2c_addr, unsigned char eeprom_offset,
;	-----------------------------------------
...
_eeprom_read:
	...
	ar1 = 0x01
	mov	r2,dpl
;	eeprom_io.c:36: cmd[0] = eeprom_offset;
	mov	dptr,#_eeprom_read_cmd_1_1
	mov	a,_eeprom_read_PARM_2
	movx	@dptr,a
;	eeprom_io.c:37: if (!i2c_write(i2c_addr, cmd, 1))
	...
	mov	a,dpl
	pop	ar2
;	eeprom_io.c:38: return 0;
	jnz	00102$
	mov	dpl,a
	ret
00102$:
;	eeprom_io.c:40: return i2c_read(i2c_addr, buf, len);
